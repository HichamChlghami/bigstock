...
async function GET() {
    try {
        const collection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])('orders');
        const orders = await collection.find({}).sort({
            date: -1
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__74f648aa._.js.map