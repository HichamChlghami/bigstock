...
const DataProvider = ({ children })=>{
    ...
    const addProduct = async (product)=>{
        ...
        const res = await fetch('/api/products', {
            ...
            body: JSON.stringify({
                ...productData,
                slug: product.slug || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$slugify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slugify"])(product.name)
            })
        });
        if (res.ok) {
            refreshData();
...
//# sourceMappingURL=src_c05038e3._.js.map